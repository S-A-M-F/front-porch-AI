...
class RealismEvals {
  ...
  Future<void> evaluateRelationshipCall({
    ...
    final prompt =
        ...
        ')\n'
        '   Trust is SUBJECTIVE to $charName\'s personality and what she values. It moves slower than warmth, but it SHOULD move whenever $userName is genuinely honest, consistent, caring, or present — small trust accrues over time. Examples:\n'
        ...
        '   +5: did exactly what $charName values most | +3: showed honesty, reliability, or care she clearly notices | +1 to +2: a small, genuine moment of consistency, attentiveness, or kindness\n'
        '   0: ONLY a truly neutral or purely logistical exchange\n'
        '   -2: a small letdown, evasiveness, or broken minor expectation | -5: something $charName finds personally untrustworthy given her personality | -30: deliberate deception or betrayal | -200: Unforgivable betrayal\n'
