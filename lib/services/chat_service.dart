...
class ChatService extends ChangeNotifier {
  ...
  static const List<String> _chanceTimeEventPool = [
    // 🟢 Fortune — good things happen to good people (sometimes)
    '{{char}} has just received an unexpected and significant windfall of wealth',
    '{{char}} has been offered an opportunity they have quietly dreamed of for years',
    '{{char}} just discovered they have a rare skill others are willing to pay handsomely for',
    '{{char}} has received an unexpected inheritance from a distant relative',
    '{{char}} has been publicly recognized and praised for something they did',
    '{{char}} has received a heartfelt and sincere apology from someone who wronged them long ago',
    '{{char}} just won a substantial prize through a game of chance',
    '{{char}} has been offered a position of greater prestige and responsibility',
    '{{char}} received an anonymous gift of considerable value with no explanation',
    '{{char}} was just told their work will be celebrated or featured publicly',
    '{{char}} has discovered their long-standing debt was quietly paid off by an unknown benefactor',
    '{{char}} received extraordinarily good news from a physician or healer today',
    'A long-lost person dear to {{char}} has just made contact after years of silence',
    '{{char}} has discovered far more resources at their disposal than they realized',
    '{{char}} was approached to be the subject of a written or artistic portrait',
    '{{char}} received a deeply sincere compliment from a stranger that left them speechless',
    '{{char}} found a significant sum of valuables that appear to have been abandoned',
    '{{char}} was chosen for something they applied for and had nearly given up on',
    '{{char}} has just received a letter bearing tremendously good news',
    '{{char}} discovers that a long-standing rival has suffered a major and public setback',
    '{{char}} has been offered lodging, hospitality, or resources they desperately needed',
    '{{char}} has discovered a hidden ability or talent they never knew they possessed',
    '{{char}} overheard a conversation that works entirely in their favor',
    'An influential person has quietly become one of {{char}}\'s most ardent advocates',
    '{{char}}\'s creative work or labor has just been recognized as exceptional by the right person',
    'A door {{char}} thought permanently closed has just reopened unexpectedly',
    '{{char}} has been invited to a prestigious or exclusive gathering',
    'Someone {{char}} deeply admires has just expressed genuine admiration in return',
    '{{char}} finds themselves suddenly and unexpectedly in a position of considerable advantage',
    'A long-standing problem has resolved itself without any intervention from {{char}}',
    // 🔴 Misfortune — life is unfair and chaos is the natural state
    '{{char}} is currently dealing with a violent and humiliating stomach illness',
    '{{char}}\'s primary means of travel or conveyance has just been destroyed or made unusable',
    '{{char}} has just been dismissed from their position without warning or explanation',
    '{{char}} woke to a severe and debilitating bout of food-related illness',
    '{{char}} is having a serious and alarming physical reaction and trying not to panic',
    'A financial authority or debt collector has arrived with very unwelcome demands',
    'A structural failure has caused significant flooding or damage to {{char}}\'s dwelling',
    '{{char}}\'s most critical tool or instrument has just been destroyed beyond repair',
    '{{char}} slipped and fell completely in a very public setting',
    '{{char}} is locked out of their home and every alternative has failed',
    '{{char}} is suffering what may be the worst tooth pain of their life',
    '{{char}} has just discovered something with far too many legs in their personal space',
    '{{char}}\'s name or identity is being used fraudulently by another person',
    '{{char}} stumbled into a swarm of stinging insects and did not escape cleanly',
    '{{char}} delivered a deeply embarrassing private message to entirely the wrong recipient',
    '{{char}} is dealing with a catastrophic and very visible wardrobe failure in public',
    '{{char}} has been summoned for an unwanted civic or official obligation at the worst possible time',
    '{{char}} discovered a severe pest infestation throughout their home or lodgings',
    '{{char}}\'s travel arrangements have completely collapsed and they are now stranded',
    '{{char}} accidentally destroyed something that cannot be replaced or repaired',
    '{{char}}\'s access to their own funds or resources has been cut off without explanation',
    '{{char}} has been informed their place of residence is about to be taken from them',
    '{{char}} received a bill or demand for an amount completely beyond their means',
    '{{char}} woke to a mysterious ailment that shows no signs of improving',
    '{{char}} stepped on something extremely painful and sharp in the darkness',
    '{{char}} accidentally ruined something of great personal value to someone else',
    'A secret {{char}} was guarding carefully has been discovered and made public',
    '{{char}} was robbed in a place they had always believed to be completely safe',
    '{{char}} was publicly penalized or fined on an already devastating day',
    '{{char}} has just discovered that someone close to them has been deceiving them for months',
    '{{char}} publicly humiliated themselves in front of precisely the wrong people',
    '{{char}} choked on something at an absolutely critical and inopportune moment',
    'A deeply personal message intended for one person was received by many',
    '{{char}} suffered a complete emotional collapse in a very public and exposed setting',
    'Someone {{char}} genuinely cared for has abruptly and without explanation severed all contact',
    '{{char}} has discovered a worrying physical symptom and is trying very hard not to dwell on it',
    '{{char}}\'s former lover has just announced a new betrothal — to {{char}}\'s close companion',
    '{{char}} tripped and went sprawling completely in front of a large and attentive crowd',
    '{{char}} lost hours of critical work in an instant due to a sudden and unforeseen accident',
    '{{char}} has just received a devastating rejection from something they worked years to achieve',
    '{{char}} overslept and missed something of critical and irreversible importance',
    '{{char}} has been stranded in transit for hours and the situation is deteriorating',
    '{{char}} accidentally revealed something deeply private in front of entirely the wrong people',
    '{{char}}\'s beloved animal companion has just died and {{char}} has told no one yet',
    '{{char}} received a demand for payment that is twice what was originally agreed',
    '{{char}} has injured their mouth badly enough that speaking and eating are genuinely difficult',
    '{{char}} was bitten or stung by something unidentified and is unsure how seriously to take it',
    '{{char}} was publicly condemned for something they said only in what they thought was private',
    '{{char}}\'s attempt to pay for something was refused in a deeply embarrassing setting',
    '{{char}} woke to discover that their property or possessions had been seized or removed overnight',
    '{{char}} learned their compensation is significantly less than a peer doing the exact same work',
    '{{char}} was taken ill in a manner and location that is extremely difficult to manage with dignity',
    '{{char}} has been walking around with a visible and embarrassing problem for hours without knowing',
    '{{char}}\'s journey was cancelled at the last moment, leaving them without resources or options',
    'Someone {{char}} confided in has shared their private words with others without permission',
    // 💛 Chaos — the universe is indifferent and strange
    'A significant tremor or earth-shaking event has just struck {{char}}\'s location',
    'All light and power has suddenly and completely failed where {{char}} is',
    'Something large and unidentified has been spotted moving in the sky above {{char}}\'s location',
    '{{char}} has become inadvertently caught in the middle of a large and chaotic spontaneous gathering',
    'A person of enormous fame or authority has just appeared in {{char}}\'s immediate vicinity',
    'A severe and sudden weather event has been warned for {{char}}\'s region',
    'A group claiming to record or document events has arrived and fixed their entire attention on {{char}}',
    'Something of enormous public significance is being reported right in {{char}}\'s vicinity',
    'All communication across {{char}}\'s region has inexplicably and completely ceased',
    'A catastrophic accident nearby has sent everything around {{char}} into complete disorder',
    'A dangerous creature has been reported loose very near {{char}}\'s current location',
    'A hazardous condition or substance has just been detected in {{char}}\'s immediate environment',
    'Observers appear to be watching {{char}}\'s location with unusual and focused intensity',
    'Every major channel of public information has gone dark simultaneously without explanation',
    'A strange and unexplained crowd has gathered directly outside {{char}}\'s location',
    '{{char}}\'s location has been evacuated due to an unspecified alarm or threat',
    'All movement into or out of {{char}}\'s area has been halted by some authority',
    '{{char}} is caught in a sudden and severe weather event that appeared without warning',
    'Every alarm in {{char}}\'s vicinity has triggered simultaneously without any apparent cause',
    'A single enormous creature will not stop watching {{char}} with what feels like deliberate focus',
    'A figure in strange or inappropriate attire has appeared nearby and seems to be specifically addressing {{char}}',
    '{{char}} is experiencing the most overwhelming and disorienting sense of déjà vu of their life',
    'A nearby performer is playing music of deeply specific and personal significance to {{char}}',
    'The ground directly beneath {{char}} shifted once with no follow-up and no explanation',
    'A complete stranger rushed to {{char}}, spoke something urgent and incomprehensible, and vanished',
    'Every surface capable of displaying information near {{char}} is showing the same inexplicable thing',
    '{{char}} has just witnessed something they cannot begin to explain to anyone',
    'Someone nearby collapsed dramatically and completely without any apparent cause',
    'An alarm triggers only when {{char}} specifically is in the room — and nobody else',
    '{{char}}\'s location has suddenly become the focus of intense and bewildering public attention',
    // 💜 Wild Cards — it's the characters, not the setting, that matter
    '{{char}} has been keeping a serious secret and is dangerously close to breaking',
    '{{char}} is secretly in love with someone and expending enormous effort not to show it',
    '{{char}} received devastating personal news immediately before this conversation began',
    '{{char}} has an identity or history they have concealed from almost everyone',
    '{{char}} is currently being coerced or blackmailed by someone',
    '{{char}} has an identical sibling that almost no one in their life knows exists',
    '{{char}} was once offered a life-changing proposal and refused it — and deeply regrets it',
    '{{char}} is concealing a significant injury and working very hard not to let it show',
    '{{char}} overheard something that was never meant for their ears',
    '{{char}} is protecting someone dangerous and cannot explain the reason to anyone',
    '{{char}} has a strong premonition that something terrible is about to happen',
    '{{char}} made a solemn promise they now realize they cannot possibly keep',
    '{{char}} has already made a decision that will irrevocably change the course of their life',
    '{{char}} once did something they are deeply ashamed of and has told no one',
    '{{char}} is not entirely the person they have presented themselves to be',
    '{{char}} has recently recognized someone from a chapter of their past they do not speak of',
    '{{char}} is forcing themselves to be present in this moment and it is costing them everything',
    '{{char}} is furious about something and holding it together with a strength that is visibly slipping',
    '{{char}} received a message today that changed everything they believed about their situation',
    '{{char}} has been maintaining a small deception for so long it has become an enormous problem',
    '{{char}} is consumed by jealousy over something specific and refuses to acknowledge it even privately',
    '{{char}} has been suppressing feelings for someone for far longer than is healthy',
    '{{char}} is grieving something silently that they have not disclosed to a single person',
    '{{char}} has been plagued by a recurring nightmare that is visibly affecting them',
    '{{char}} has just made a choice from which there is no going back',
    '{{char}} has the distinct and unsettling feeling they are being watched or followed',
    '{{char}} has a specific fear that was triggered within the last hour',
    '{{char}} has just arrived at a realization about themselves they cannot undo',
    '{{char}} is using every remaining resource to prevent their tears from showing',
    '{{char}} is carrying a truth that would completely change how everyone around them sees them',
  ];
}
