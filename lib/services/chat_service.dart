...
class ChatService extends ChangeNotifier {
  ...
  static const List<String> _chanceTimeEventPool = [
    ...
    // 🔴 Misfortune (extended — because life is unfair)
    '{{char}} just publicly humiliated themselves in front of people they were trying to impress',
    '{{char}} got food stuck in their throat at the worst possible moment',
    '{{char}} accidentally sent a very personal voice memo to the wrong group chat',
    '{{char}} just had a full emotional breakdown in a public bathroom',
    '{{char}} got ghosted by someone they genuinely cared about today',
    '{{char}} just found a lump and is trying very hard not to think about it',
    '{{char}}\\'s ex just announced they\\'re engaged — to {{char}}\\'s friend',
    '{{char}} tripped and went completely sprawling in front of a large crowd',
    '{{char}}\\'s computer crashed with hours of unsaved work',
    '{{char}} just got a devastating rejection from something they\\'d worked toward for years',
    '{{char}} overslept and missed something critically important today',
    '{{char}} is stuck in traffic and has been for two hours with a full bladder',
    '{{char}} accidentally revealed something deeply private in front of the wrong people',
    '{{char}}\\'s dog/cat just passed away and {{char}} hasn\\'t told anyone yet',
    '{{char}} just got a bill that is twice what they expected',
    '{{char}} burned their mouth so badly they can barely speak or eat',
    '{{char}} got bitten by something and doesn\\'t know what',
    '{{char}} just got publicly called out for something they said privately',
    '{{char}}\\'s debit card got declined somewhere very embarrassing',
    '{{char}} woke up to find their car was towed overnight',
    '{{char}} accidentally liked a 3-year-old photo while deep-stalking an ex',
    '{{char}} found out their salary is significantly lower than a coworker doing the same job',
    '{{char}} threw up in a place that was very difficult to clean up',
    '{{char}} just realized they\\'ve been walking around with a wardrobe issue for hours',
    '{{char}}\\'s flight got cancelled and they\\'re stranded with a dead phone battery',
    // 💛 Chaos
